<template>
	<nav class="fixed left-0 top-0 h-full bg-stone-200/80 w-52 shadow-sm hover:shadow-xl py-16 px-8">
		<div class="flex flex-col justify-around items-center h-full">
			...
			<ul class="nav-list text-slate-800">
				<li class="py-4">
					<router-link to="/" class="flex text-slate-400 hover:text-slate-500 transition-colors" data-cy="nav-dashboard">
						...
						<span class="ml-2 text-lg text-slate-500">Dashboard</span>
					</router-link>
				</li>
				...
				<li class="py-4">
					<router-link to="/budget" class="flex text-slate-400 hover:text-slate-500 transition-colors" data-cy="nav-budget">
						...
						<span class="ml-2 text-lg text-slate-500">Budgets</span>
					</router-link>
				</li>
				...
				<li class="py-4">
					<router-link to="/invest" class="flex text-slate-400 hover:text-slate-500 transition-colors" data-cy="nav-invest">
						...
						<span class="ml-2 text-lg text-slate-500">Supports</span>
					</router-link>
				</li>
			...
			<p class=" text-gray-700 mb-8">Créé par <span
					class="font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-fill-color">Antoine
					Marionneau</span></p>
		</div>
	</nav>
</template>
